...
echo ""
printf "\033[1;31m✅ Вы можете свободно закрывать терминал - нода продолжит работу\033[0m\n"
echo ""
...
printf "\033[1;32m================================================\033[0m\n"
echo ""
printf "🔗 Просмотр логов: tmux a -t nexus\n"
printf "🔙 Выход из логов: Ctrl+B, затем D\n"
